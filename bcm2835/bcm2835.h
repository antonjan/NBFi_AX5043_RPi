...
typedef enum
{
    ...
    BCM2835_REGBASE_SYST = 11  /*!< Base of the SYST registers. */
} bcm2835RegisterBase;
...
extern "C" {
    ...
    */
    ...
    /*
     *
     * GPIO interrrupt realization
     * Copied from master https://github.com/joan2937/pigpio
     * 2020.01.17
     *
     */
    ...
    #define SOFT_ERROR(x, format, arg...) return x;
    ...
    int bcm2835_gpioSetISRFunc(
       unsigned gpio,
       unsigned edge,
       int timeout,
       gpioISRFunc_t f);

    int bcm2835_gpioSetISRFuncEx(
       unsigned gpio,
       unsigned edge,
       int timeout,
       gpioAlertFuncEx_t f,
